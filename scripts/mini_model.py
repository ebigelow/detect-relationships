...
parser.add_option("--save_dir",   default=data_dir + "mini/models/embed/vg-test1/")
...
parser.add_option("--learning_rate", default=1e-2,   type="float")
parser.add_option("--lamb1",         default=.05,    type="float")
parser.add_option("--lamb2",         default=.001,   type="float")
parser.add_option("--noise",         default=1e-3,  type="float")
