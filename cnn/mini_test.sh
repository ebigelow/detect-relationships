...
CNN_DIR=$MINI_DIR"models/cnn/obj_vg1/"
WEIGHTS=$MINI_DIR"models/cnn/obj_vg1/vgg16_15000.npy"  # TODO number
runtest()
{
  python mini_test.py --output_size $OUTPUT_SIZE --which_net $WHICH_NET --weights $WEIGHTS --save_file $1 --batch_size $BATCH_SIZE --data_epochs $DATA_EPOCHS --data_file $2 --img_dir $3 --mean_file $MEAN_FILE
}
...
CNN_DIR=$MINI_DIR"models/cnn/rel_vg2/"
WEIGHTS=$MINI_DIR"models/cnn/rel_vg2/vgg16_6000.npy"  # TODO number
runtest()
{
  python mini_test.py --output_size $OUTPUT_SIZE --which_net $WHICH_NET --weights $WEIGHTS --save_file $1 --batch_size $BATCH_SIZE --data_epochs $DATA_EPOCHS --data_file $2 --img_dir $3 --mean_file $MEAN_FILE
}
