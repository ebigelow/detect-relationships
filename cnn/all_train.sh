...
# OUTPUT_SIZE=40
# WHICH_NET="rel"
# SAVE_DIR="/home/eric/data/mini/models/cnn2/rel_vg1/"
#
...
# OUTPUT_SIZE=96
# WHICH_NET="obj"
# SAVE_DIR="/home/eric/data/mini/models/cnn2/obj_vg1/"
#
# setup_savedir $SAVE_DIR
# python vg_train_cnn2.py --output_size $OUTPUT_SIZE --which_net $WHICH_NET --save_dir $SAVE_DIR --init_path $INIT_PATH --learning_rate $LEARNING_RATE --batch_size $BATCH_SIZE --data_epochs $DATA_EPOCHS --meta_epochs $META_EPOCHS --test_freq $TEST_FREQ --save_freq $SAVE_FREQ
...
# OUTPUT_SIZE=96
# WHICH_NET="obj"
# SAVE_DIR="/home/eric/data/mini/models/cnn2/obj_vrd1/"
#
# setup_savedir $SAVE_DIR
...
OUTPUT_SIZE=40
WHICH_NET="rel"
SAVE_DIR="/home/eric/data/mini/models/cnn2/rel_vrd1/"
