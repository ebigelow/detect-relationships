...
tf.app.flags.DEFINE_integer('output_size', 'output_size', 'Size of final output layer')
tf.app.flags.DEFINE_string('which_net', 'objnet', '')

tf.app.flags.DEFINE_string('init_path', 'data/models/objnet/vgg16a.npy', 'Initial weights')
...
if __name__ == '__main__':
    data_batcher = load_data_batcher(FLAGS.obj_list, FLAGS.rel_list, FLAGS.train_mat,
                                     FLAGS.batch_size, FLAGS.meta_epochs, FLAGS.which_net)
    test_batcher = load_data_batcher(FLAGS.obj_list, FLAGS.rel_list, FLAGS.test_mat,
